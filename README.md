...
- [x] 中国法定节假日（SC-011：放假 / 补班数据、连休分组、年份数据版本；月格视觉由 SC-013 完成）
- [x] 中国传统节日（SC-012：春节、元宵、龙抬头、清明、端午、七夕、中元、中秋、重阳、腊八、除夕）
- [x] 二十四节气（SC-012：1901–2100；月格标签、详情栏与背景引用接口）
- [x] 英超事件识别
- [x] 英超球队元数据
...
SC-011 之后仍未接线：传统节日与节气（SC-012）、语义日期格与多语义冲突规则（SC-013）、本地通知（SC-017）、设置页（SC-018）。
